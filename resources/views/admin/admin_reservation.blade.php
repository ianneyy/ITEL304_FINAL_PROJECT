        ...
        <div id="nav-content">
            ...
            <div class="nav-button">
                <a href="{{ url('admin-reservation') }}" style="text-decoration: none; color: inherit;"
                    ...
                    </svg></i><span style="color: #FFBD2E;">Reservations</span><span id="admin-reservation-badge"
                        class="badge bg-warning text-dark" style="display: none; border-radius: 50%;">0</span>
                </a>
            </div>
                            ...
                            <tr>
                                ...
                                <td style=" width:80px;">
                                    <div class="action" style=" width:60px;">
                                        <div class="ed px-3"><a href="{{ url('paid-reservation/' . $d['id']) }}"
                                                style="color: #936d1b;">Confirm</a></div>
                                    </div>
                                </td>
                            </tr>
                        @empty
                                ...
                                <tr>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <img src="../img/no_data.svg" alt="No Data" class="nodata-image"
                                            style="max-width: 100px; height: auto; margin-top: 50px;">
        ...
        <div class="recent-activity p-5 mt-5">
            ...
            <div class="overflow">
                <table class="table my-8" id="completedReservations">
                    ...
                    <tbody>
                        @forelse($data['completedData'] as $completed)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                ...
                                <td style=" width:80px;"> <span
                                        class="badge bg-success">{{ $completed['status'] }}</span>
                                </td>
                            </tr>
                        @empty
                            <table class="no-data" style="display: flex; justify-content: center; align-items: center;">
        ...
        <div class="recent-activity p-5 mt-5">
            ...
            <div class="overflow">
                ...
                <table class="table my-8" id="cancelledReservations">
                    ...
                    <tbody>
                        @forelse($data['cancelledData'] as $cancelled)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                ...
                                <td style=" width:80px;"> <span class="badge bg-danger">{{ $cancelled['status'] }}</span>
                                </td>
                            </tr>
                        @empty
                            <table class="no-data" style="display: flex; justify-content: center; align-items: center;">
