    ...
    <div class="container p-5 col-xl-9">
        ...
        @forelse($data['data'] as $d)
            <form action="{{ url('reply/' . $d['id']) }}" method="post">
                @csrf
                <div class="message" data-id="{{ $d['id'] }}" data-email="{{ $d['email'] }}"
                    data-name="{{ $d['name'] }}">
                    ...
                    <div class="message-content">
                        ...
                        <div class="reply-wrapper" style="display:none;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 24 24">
                                <path fill="#357ac8"
                                    d="M9 16h7.2l-2.6 2.6L15 20l5-5l-5-5l-1.4 1.4l2.6 2.6H9c-2.2 0-4-1.8-4-4s1.8-4 4-4h2V4H9c-3.3 0-6 2.7-6 6s2.7 6 6 6" />
                            </svg>
                    ...
                    <div class="modal-content">
                        ...
                        <div id="reply-form">
                            ...
                            <div class="input-wrapper mb-3">
                                ...
                                <textarea class="input w-100" id="reply-message" rows="3" placeholder="Type your reply here..."
