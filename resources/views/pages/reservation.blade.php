...
@section('content')
    ...
    <div id="nav-bar">
        ...
        <div id="nav-content">
            ...
            <div class="nav-button"><a href="{{ url('student/announcement') }}">
                    ...
                    </svg><span>Announcements</span><span id="reservation-badge" class="badge bg-warning text-dark"
    ...
    <div class="containerr p-5 col-xl-9">
        <form action="{{ url('student/reservation') }}" method="post">
            ...
            <table>
                <tr>
                    <th style="border-top-left-radius: 10px; border-bottom-left-radius: 10px;">Item Name</th>
                    <th>Variation</th>
                    <th>Size</th>
                    <th>Quantity</th>
                ...
                @forelse($data['data'] as $d)
                    <tr>
                        ...
                        <td><span data-id="{{ $d['id'] }}" style="color: #a80000" class="cancel-btn">Cancel</span>
                        </td>
                    ...
                    <table class="no-data" style="display: flex; justify-content: center; align-items: center;">
                        <tr>
                            <td style="text-align: center; vertical-align: middle;">
                                <img src="../img/no_data.svg" alt="No Data" class="nodata-image"
    ...
    <div class="cancel-card">
        <div class="card-content">
            <p class="card-heading">Cancel item?</p>
            <p class="card-description">Are you sure you want to cancel this item? This action cannot be undone.</p>
        </div>
        <div class="card-button-wrapper">
            <button class="card-button secondary">No, Keep Item</button>
            <a id="delete-link" href="#" class="card-button primary"
                style="text-align:center; display: flex; justify-content: center; align-items:center;"> Yes, Cancel
                Item</a>
        </div>
    ...
    @if (session('success'))
        <div class="success" style="display: flex;">
            ...
            <div class="success__title">Reservation cancelled</div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            cancelButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    console.log(id);
                    const cancelUrl = '/cancel-reservation/' + id;

                    document.getElementById('delete-link').setAttribute('href', cancelUrl);

                    cancelCard.classList.add('active');
            ...
            closeModalButtons.forEach(button => {
                button.addEventListener('click', function() {
                    cancelCard.classList.remove('active');
